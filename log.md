...
As with Classes 6 and 7, neither Veblika reference covers this material — the video is the sole source. All new notes at origin: ai / maturity: supported. No secrets or PII.
Agent: claude-code
