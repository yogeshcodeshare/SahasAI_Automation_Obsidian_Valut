...
The related recording `2_1 GoHighLevel Ads Manager for Lead Generation.mp4` adds visual evidence for Media Storage, Meta portfolio/ad-account access, campaign/ad-set/ad structure, creative and placement previews, Facebook lead forms, privacy/disclaimer fields, and review/publish checkpoints. See [[ghl-ads-manager-lead-generation-lecture-visual-notes]]. This is capability evidence only; it does not change the current Phase 2 sequencing or establish current pricing, policy, or account eligibility.

The related recording `3_1 Social Media Scheduling and Comment Management.mp4` adds visual evidence for Social Planner, connected social accounts, multi-channel post composition, media selection, channel-specific previews, planner status rows, and centralized comment/reply handling. See [[ghl-social-media-scheduling-comment-management-lecture-visual-notes]]. This is capability evidence only; it does not change the current Phase 2 sequencing or establish current platform availability, policy, or pricing.

The refined 0:00–22:00 cut of `3_2 Build Instagram DM Automation in GoHighLevel.mp4` adds visual evidence for Instagram DM Customer Replied triggers, Instagram Interactive Messenger actions, buttons/quick replies, Default Timeout/GRAB OFFER/Whatsapp Us branches, Add Tag, recipient testing, and Conversations handoff. See [[ghl-instagram-dm-automation-lecture-visual-notes]]. This is capability evidence only; it does not change the current Phase 2 sequencing or establish current platform availability, policy, pricing, or account eligibility.

The local recording `3_3 Automate Instagram Comments and DMs in GoHighLevel.mp4` adds visual evidence for Instagram comment triggers on published posts, page/post filters, first-level comment tracking, `Respond On Comment`, `Instagram Interactive Messenger`, example offer branching, Instagram testing, and Social Planner comment review/reply controls. See [[ghl-instagram-comments-dms-lecture-visual-notes]]. This is capability evidence only; it does not change the current Phase 2 sequencing or establish current platform availability, policy, pricing, or account eligibility.
