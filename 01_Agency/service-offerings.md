...
What Sahas AI sells to local SMBs. Pricing in [[pricing-ladder]].
...
Run GMB Sarathi audits on the 10 biggest businesses in a vertical, rank by score, walk into the **lowest scores first** (they feel the pain). Demo-mode audits until DataForSEO funded.

## Best vertical
Coaching classes (one admission = ₹25k–1L → one extra admission pays your year). See [[coaching-class-vertical-playbook]].
